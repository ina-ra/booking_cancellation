...
- Возможное использование time-based split (если данные временные)  
- Учет дисбаланса классов (отмены vs неотмены)  
...
- Готовый скоринг всех бронирований  
- Сегмент высокого риска, подготовленный для пилота  
