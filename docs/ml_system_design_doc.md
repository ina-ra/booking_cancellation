...
2. **Этап 2. Shadow mode / controlled pilot**
...
Таким образом, пилот считается корректно поставленным только тогда, когда модель измеряется и как ML-инструмент, и как инструмент улучшения бизнес-процесса. Эта логика согласуется с тем, как в хороших примерах раздел 3 связывает модель с реальным бизнес-экспериментом. fileciteturn5file0 fileciteturn5file1
